...
void secoundlaw()
{
    printf("Entropy of a isolated system always increases, heat flows from hot body to a cold body.");
}

void thirdlaw()
{
    printf("Entropy of a system approaches a constant as temperature approaches absolute zero.");
}